...
void main() {
  ...
  test('mock repository exposes countries and story clusters from local catalog', () async {
    ...
    expect(stories.every((story) => story.sourceArticles.length >= 1), isTrue);
  });
  ...
  test('mock repository sorts underreported and positive feeds', () async {
    ...
    expect(underreported.first.underreportedScore, greaterThanOrEqualTo(underreported.last.underreportedScore));
